...
//#ifdef 	DEBUG
//#define CONFIG_PATH     "/home/libin/config.json"
//#else
//#define CONFIG_PATH     "/home/flw/dev/server/config.json"
//#endif
...
int main()
{
	...
	try
	{
		...
		{
			ServerErrorException e(__FILE__, __LINE__,  "fail to parse json config");
			throw e;
		}

		is.close();

		srv = new Server(tcp_port, udp_port, pool_size,  pool_task, timeout, interval);
		srv->Start();
	}
